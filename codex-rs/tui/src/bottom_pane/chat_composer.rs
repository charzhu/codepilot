...
impl ChatComposer {
    fn builtin_command_flags(&self) -> BuiltinCommandFlags {
        BuiltinCommandFlags {
            ...
            league_command_enabled: self.league_command_enabled,
    ...
    pub fn set_league_command_enabled(&mut self, enabled: bool) {
        self.league_command_enabled = enabled;
    }
        ...
        match &mut self.popups.active {
            ...
            _ => {
                if is_editing_slash_command_name {
                    ...
                    let league_command_enabled = self.league_command_enabled;
