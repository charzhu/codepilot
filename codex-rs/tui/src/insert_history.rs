...
fn write_history_line<W: Write>(
    ...
    let clear_style = style_with_history_fallback(line.line.style, fallback_style);
    ...
    let merged_spans: Vec<Span> = line
        ...
        .iter()
        .map(|s| Span {
            style: style_with_history_fallback(s.style.patch(line.line.style), fallback_style),
