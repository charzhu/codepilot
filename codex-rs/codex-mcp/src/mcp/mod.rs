...
pub use auth::compute_auth_statuses_with_github_copilot_runtime_auth;
...
pub async fn read_mcp_resource(
    ...
    let github_copilot_runtime_auth_available =
        github_copilot_runtime_auth_available_for_servers(mcp_servers.iter(), &config.codex_home)
            .await;
    let auth_statuses = compute_auth_statuses_with_github_copilot_runtime_auth(
        mcp_servers.iter(),
...
pub async fn collect_mcp_server_status_snapshot_with_detail(
    ...
    let github_copilot_runtime_auth_available =
        github_copilot_runtime_auth_available_for_servers(mcp_servers.iter(), &config.codex_home)
            .await;
    let auth_status_entries = compute_auth_statuses_with_github_copilot_runtime_auth(
        mcp_servers.iter(),
        config.mcp_oauth_credentials_store_mode,
        config.auth_keyring_backend_kind,
        auth,
