...
{
    compute_auth_statuses_with_github_copilot_runtime_auth(
        servers,
        store_mode,
...
pub async fn compute_auth_statuses_with_github_copilot_runtime_auth<'a, I>(
    servers: I,
    store_mode: OAuthCredentialsStoreMode,
    keyring_backend_kind: AuthKeyringBackendKind,
    auth: Option<&CodexAuth>,
...
async fn compute_auth_status(
    ...
    if missing_runtime_auth {
        return Ok(McpAuthState::LoggedOut(McpLoginRequirement::Login));
    }
